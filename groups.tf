...
provider "google-beta" {
  ...
  billing_project       = "cs-host-a0069d44919843bc88b4e6"
}
...
module "cs-gg-nonprod1-service" {
  ...
  id           = "nonprod1-service@atdomain.org"
...
module "cs-gg-nonprod2-service" {
  ...
  id           = "nonprod2-service@atdomain.org"
